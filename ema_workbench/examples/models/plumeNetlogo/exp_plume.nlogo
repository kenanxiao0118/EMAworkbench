...
to symmetric-search
  ...
  ask turtles [
    ...
    ifelse (xcor < my-region-xmin + ssbt) or
            xcor > (my-region-xmax - ssbt) or
            ycor < (my-region-ymin + ssbt) or
            ycor > (my-region-ymax - ssbt) [
...
to-report get-optimal-subregion-dimensions
  ...
  let optimal (list 1 1 population)
  let h 1
